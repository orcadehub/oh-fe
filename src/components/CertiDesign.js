...
import Logo from "../assets/orcade.png";
...
const CertiDesign = ({ certificateDetails }) => {
  ...
  const certificateData = {
    1: {
      ...
      body: `This certificate is awarded in recognition of the successful completion of an internship program. The recipient has displayed excellent work ethic, contributed significantly to the projects, and acquired valuable skills in a professional environment. The internship was held from ${new Date(
        certificateDetails.startDate
      ).toLocaleDateString()} to ${new Date(
        certificateDetails.endDate
      ).toLocaleDateString()}, showcasing the recipient's commitment and dedication.`,
    },
    2: {
  ...
  return (
    <Container
      fluid
      className="certificate-container shadow-lg bg-dark-subtle cd-box"
    ...
    >
      <Row>
        ...
        <Col md={9} className="p-3">
          <Card className="certificate-content ps-4 pe-4">
            <Card.Body>
              ...
              <div className="mt-4">
                ...
                <p style={{ textAlign: "justify" }}>{certificateBody}</p>
              </div>
